...
Later in 3 or 4 weeks, I start using parallel coordinate plots for features to see the relation instead of plotting 2D plot as pair plot graph becomes less meaningful for higher dimensions.
...
| Functions                    | Initial Best(y) | Week 13 best (y) | Strategy used               |
|:-----------------------------|:----------------|:-----------------|:----------------------------|
...
| F4: Warehouses storage       | -6.702089       | 0.316342         | Standard GP                 |
| F5: Chemical process         | 1088.859618     | 2.145994e+07     | Standard GP + Extrapolation |
| F6: Cake recipe              | -0.714265       | -0.303087        | Standard GP                 |
...
- Query budget is restricted to 13-week limit.
